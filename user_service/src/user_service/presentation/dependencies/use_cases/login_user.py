...
from user_service.presentation.dependencies.use_cases.jwt_token_generator import jwt_token_generator_use_case_depends
from user_service.presentation.dependencies.use_cases.password_hasher import password_hasher_use_case_depends
...
async def login_user_use_case_depends(
        ...
        jwt_token_generator: JWTTokenGeneratorRepo = Depends(jwt_token_generator_use_case_depends)
) -> LoginUserUseCase:
